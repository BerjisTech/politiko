...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create party' do
    assert_difference('Party.count') do
      post parties_url,
           params: { party: { about: @party.about, created_by: @party.created_by, current_chair: @party.current_chair,
                              history: @party.history, manifesto: @party.manifesto, name: @party.name } }
    end
